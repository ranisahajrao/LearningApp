...
function SessionMgmt() {
    ...
    const handleSubmit = async (event) =>{
        ...
        setBtnClick('')
        setBtnSubmitClick(!btnSubmitClick)
    }
       ...
       // alert(course)
         courseList.map(carditem =>{
            if(Object.values(carditem)[0] === e.target.value){
                ...
                console.log(Object.values(carditem)[2])
    ...
    const validData = () =>{
        ...
        let temp = {}
        temp.courseTitle = values.courseTitle ? ""  :  "Course Title is required"
